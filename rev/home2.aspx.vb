...
Partial Class home
    ...
    Protected Sub view_alumni_Click(sender As Object, e As EventArgs) Handles view_timeline.ServerClick
        frame1.Attributes("src") = "alumni/timeline.aspx"
    End Sub

    Protected Sub view_message_Click(sender As Object, e As EventArgs) Handles view_message.ServerClick
        frame1.Attributes("src") = "director/survey-pending.aspx"
    End Sub
