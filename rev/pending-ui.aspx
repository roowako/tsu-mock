            ...
            function pullFromServer() {
                ...
                $.ajax({
                    ...
                    success: function (r) {
                            ...
                            $("#surveyPlaceholder tbody").append(
                                ...
                                "<td style='text-align:right;'>" +
                                    "<div class='btn-group' role='group'>" +
                                      ...
                                      "<a class='btn btn-danger btn-sm rejectSurvey' data-survey-id='" + object.polls_idpk + "' data-toggle='modal' data-target='.bs-example-modal-sm '><span class='glyphicon glyphicon-trash'></span></a> " +
                                    "</div>" +
                                "</td>" +
                        ...
                        //Reject Survey
                        $(".rejectSurvey").on("click", function () {
                            uid = "";
                            uid = $(this).data("survey-id");
                            $(".del_p").data("uid", uid);
                        });
